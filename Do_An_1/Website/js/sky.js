$(document).ready(function() {
    ...
    function makeTimer() {
        ...
        var endTime = new Date("20 Aug 2020 9:56:00 GMT+01:00");
...
function postToGoogle() {
    ...
    $.ajax({
        ...
        url: "https://docs.google.com/forms/d/e/1FAIpQLSffto31JxGigmCJ92jDB9q3KutRyCQEp8GXDjm_syTvOxfiAQ/formResponse?",
        //URL lấy từ link đã note ở trên nhé
        data: { //gán các giá trị tương ứng vào các Input name tương ứng đã lấy ở trên
            "entry.1099345086": name,
            "entry.989465500": email,
            "entry.2087537767": mess
        },
        type: "POST",
